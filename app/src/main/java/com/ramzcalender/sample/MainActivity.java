...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    ArrayList aa, aa1, aa2, aa3, aa4, aa5, aa6,aa7,aa8;
    ...
    public  static  String Activity_fragm,row_item_id;
    private String level_num;
    private String dataa;
    private String owne;


    String fname,lanam,emaill_id,ph,customerstatus,ades,levll,no_del;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);

        fb= (FloatingActionButton) findViewById(R.id.floating_contacts);
        task_main = (Button) findViewById(R.id.task_main);
        lead_main = (Button) findViewById(R.id.leads_main);
        contacts_main = (Button) findViewById(R.id.contacts_main);
        deal_main = (Button) findViewById(R.id.deals_main);
        calendr_main = (Button) findViewById(R.id.calender_main);

        plus_main = (Button) findViewById(R.id.plus_buton);
        btn_logout = (Button) findViewById(R.id.btn_logout);

        Activity_fragm  = "Main_cls";
        row_item_id="main";
        task_main.setOnClickListener(this);
        btn_logout.setOnClickListener(this);
        lead_main.setOnClickListener(this);
        contacts_main.setOnClickListener(this);
        deal_main.setOnClickListener(this);
        calendr_main.setOnClickListener(this);
        ...
        fb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent ii = new Intent(MainActivity.this,Contacts_page.class);
               startActivity(ii);
            }
        });
        ...
        try {
            ...
            if (entity != null) {
                ...
                JSONObject jsonobject = Roomes.getJSONObject(i);
                    ...
                    name8 = jsonobject.getString("deals");
                    aa.add(name);
                    aa1.add(name1);
                    aa2.add(name2);
                    aa3.add(name3);
          ...
          runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    RecyclerView.Adapter adapter = new RecyclerViewAdapter(aa,aa1,aa2,aa3,aa4,aa5,aa6,aa7,aa8);
    ...
    public void onClick(View v) {
        if (v.getId() == task_main.getId()) {
            ...
            Intent i1 = new Intent(MainActivity.this, Tasks_Tabs_MainPage.class);
            startActivity(i1);
            overridePendingTransition( R.anim.slide_in_up, R.anim.slide_out_up );
        }
        else if (v.getId() == lead_main.getId()) {
            Intent i2 = new Intent(MainActivity.this, Lead_MainPage.class);
            startActivity(i2);
            overridePendingTransition( R.anim.slide_in_up, R.anim.slide_out_up );
        }
    ...
    class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>  {
        ...
        ArrayList<String> number_deals;

        View view1;

        public RecyclerViewAdapter( ArrayList fnma, ArrayList lnam, ArrayList mob, ArrayList amil, ArrayList ades, ArrayList levl, ArrayList<String> stat, ArrayList owner,ArrayList num_deals) {
        ...
        public void onBindViewHolder(RecyclerViewAdapter.ViewHolder Viewholder, final int i) {
            ...
            Viewholder.dealss.setText("Deals Won :"+number_deals.get(i));
            ...
            Viewholder.img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    no_del= String.valueOf(aa7.get(i));
                    ...
                    intent.putExtra("num_deals", no_del);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder{
            ...
            TextView fnam,lnam,mob,emai,adres,stats,level,owner_nam,img,dealss;
            ...
            public ViewHolder(View view) {
                ...
                dealss= (TextView) view.findViewById(R.id.deals);
